/* Vendored verbatim (only the #include path below was adjusted to reference the sibling copy of
   rotate-bits.h in this same directory) from llama.cpp's examples/gguf-hash/deps/sha256/sha256.c
   (public domain). */
